    ...
    define(['jquery'], function ($) {
        return (function () {
            ...
            function buildToast(map) {
				...
				var $collapsElement = $(options.collapseHtml);
                var response = {
                    map: map,
                    options: options,
                    startTime: new Date(),
				...
				if (map.employee) {
                    $messageContainer.append(createBlock('div', map.employee, options.titleClass));
                }
                if (map.title) {
                ...
                if (map.iconClass || options.closeButton) {
					...
					if (options.collapseButton) {
                        $toastElement.find('.' + options.rightBlockClass).append($collapsElement);
                    }
              ...
              /*   if (options.onclick) {
                ...
                function closeToast(override) {
                    ...
                    return $toastElement.addClass('slideOutRight').delay(500).queue(function () {
                        if (options.onHidden) {
                            options.onHidden();
                        } 
            ...
            function getDefaultOptions() {
                return {
					...
					collapseButton:true,
					collapseHtml:'<i class="fa fa-angle-down collapse-icon" onclick="ShowHideCompleteNote(this)"></i>',
                    ...
                    messageClass: 'toast8-message ellipsis-multiline multiline',
                    newestOnTop: true,
                    onShown: undefined,
                    ...
                    tapToDismiss: true,
                    target: 'body',
                    timeOut:0, //5000, // Set timeOut and extendedTimeout to 0 to make it sticky
                    titleClass: 'toast8-title',
                    toastClass: 'toast8',
                      iconClasses: {
                         android: 'fa fa-sticky-note',
                        error: 'fa fa-ban',
