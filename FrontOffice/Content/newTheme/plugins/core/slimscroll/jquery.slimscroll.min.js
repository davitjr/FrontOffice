        ...
        slimScroll: function(h) {
            ...
            this.each(function() {
                ...
                function C() {
                    ...
                    this.addEventListener("MozMousePixelScroll", null , !1)) : document.attachEvent("onmousewheel", r)
                }
                function w() {
                ...
                function v() {
                    ...
                    B != l && b.trigger("slimscroll", 0 == ~~l ? "top" : "bottom")) : k = !1;
                    B = l;
                ...
                function p() {
                    a.alwaysVisible || (A = setTimeout(function() {
                        a.disableFadeOut && s || (x || y) || (c.fadeOut("slow"),
                        g.fadeOut("slow"))
                    }, 1E3))
                }
                ...
                if (b.parent().hasClass(a.wrapperClass)) {
                    ...
                    b.bind("touchmove", function(b) {
                        ...
                        (m((z - b.originalEvent.touches[0].pageY) / a.touchScrollStep, !0),
                    ...
                    m(0, !0)) : "top" !== a.start && (m(f(a.start).position().top, null , !0),
