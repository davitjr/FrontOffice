...
{
    [SessionExpireFilter]
    public class NonCreditLineCardReplaceOrderController : Controller
    {
        public ActionResult NonCreditLineCardReplaceOrder()
        {
            return PartialView("NonCreditLineCardReplaceOrder");
        }

        public ActionResult NonCreditLineCardReplaceOrderDetails()
        {
            return PartialView("NonCreditLineCardReplaceOrderDetails");
        }
        ...
        public JsonResult GetNonCreditLineCardReplaceOrder(long orderId)
        {
            return Json(XBService.GetNonCreditLineCardReplaceOrder(orderId), JsonRequestBehavior.AllowGet);
        }

        public ActionResult SaveNonCreditLineCardReplaceOrder(xbs.NonCreditLineCardReplaceOrder order)
        {
            xbs.ActionResult result = XBService.SaveNonCreditLineCardReplaceOrder(order);
