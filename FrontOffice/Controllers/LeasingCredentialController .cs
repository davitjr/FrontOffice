...
namespace FrontOffice.Controllers
{
    ...
    public class LeasingCredentialController : Controller
    {
        // GET: Credential        
        ...
        // GET: /Credentials/
        public JsonResult GetCredentials(int customerNumber, int filter)
        {
            return Json(XBService.GetLeasingCredentials(customerNumber,(xbs.ProductQualityFilter)filter), JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult CredentialTermination()
        {
            return PartialView("CredentialTermination");
        }
        ...
        public ActionResult AddNewCredential()
        {
            return PartialView("AddNewCredential");
        }

        public ActionResult PostNewAndEditedLeasingCredential(xbs.LeasingCredential credential)
        {
            return Json(XBService.SaveAndEditLeasingCredential(credential), JsonRequestBehavior.AllowGet);
        }

        public ActionResult PostRemovedCredential(int credentialId)
        {
            return Json(XBService.SaveRemovedLeasingCredential(credentialId), JsonRequestBehavior.AllowGet);
        }

        public ActionResult PostCredentialsTermination(xbs.LeasingCredential credential)
        {
            return Json(XBService.SaveClosedLeasingCredential(credential), JsonRequestBehavior.AllowGet);
        }
