...
/**
 * A helper directive for the $uibModal service. It creates a backdrop element.
 */
    ...
    var $uibModalProvider = {
      ...
      $get: ['$rootScope', '$q', '$document', '$templateRequest', '$controller', '$uibResolve', '$uibModalStack',
        function ($rootScope, $q, $document, $templateRequest, $controller, $uibResolve, $uibModalStack) {
          ...
          $uibModal.getPromiseChain = function() {
            return promiseChain;
          };
          ...
          $uibModal.open = function(modalOptions) {
            ...
            modalOptions = angular.extend({}, $uibModalProvider.options, modalOptions);
