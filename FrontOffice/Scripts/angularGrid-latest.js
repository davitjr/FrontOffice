    ...
    define('../src/rowRenderer', ["./constants", "./svgFactory", "./utils"], function (constants, SvgFactory, utils) {
        ...
        RowRenderer.prototype.addClassesToRow = function (rowIndex, node, eRow) {
            ...
            if (this.gridOptionsWrapper.getRowClass()) {
                var params = {
                    node: node, data: node.data, rowIndex: rowIndex,
        ...
        RowRenderer.prototype.createFooterCell = function (eParent, node) {
            ...
            if (this.gridOptionsWrapper.isGroupUseEntireRow()) {
                textToDisplay =
                    "Group footer - you should provide a custom groupInnerCellRenderer to render what makes sense for you";
            } else {
        ...
        RowRenderer.prototype.createCell = function (colDefWrapper, value, node, rowIndex, colIndex, $childScope) {
            ...
            if (colDef.cellStyle) {
                ...
                if (typeof colDef.cellStyle === 'function') {
                    var cellStyleParams = {
                        value: value, data: node.data, node: node, colDef: colDef, $scope: $childScope,
                        gridOptions: this.gridOptionsWrapper.getGridOptions()
                    };
